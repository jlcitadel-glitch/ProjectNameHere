...
public class SkillManager : MonoBehaviour
{
    ...
    private void EnsureRuntimeData()
    {
        ...
        WireRuntimeStarterEquipment(warrior, "warrior_boots", "warrior_pants", "warrior_gloves", "warrior_helm", "warrior_chest");
        WireRuntimeStarterEquipment(mage, "mage_hood", "mage_robe", "mage_gloves", "mage_pants", "mage_slippers");
        WireRuntimeStarterEquipment(rogue, "rogue_bandana", "rogue_tunic", "rogue_gloves", "rogue_leggings", "rogue_boots");
